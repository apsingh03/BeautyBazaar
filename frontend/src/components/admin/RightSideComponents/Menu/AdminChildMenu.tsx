...
const AdminChildMenu = () => {
  const [isOpenModal, setIsOpenModal] = useState(false);

  return (
    <div className="  bg-white px-3 py-6 shadow-lg">
      <TableWrapper
        theadArray={["S.No", "Menu Name", "Child Name", "Actions"]}
        setIsOpenModal={setIsOpenModal}
        addBtnName={"add child menu"}
      >
      ...
      <ModalWrapper isOpenModal={isOpenModal} setIsOpenModal={setIsOpenModal}>
        <div className="space-y-5">
          <div className="flex flex-col gap-1">
            <label htmlFor="parentFilter">Select Parent Filter</label>
